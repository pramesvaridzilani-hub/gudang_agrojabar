...
const PRODUK_BANDUNG: { nama: string; varian?: string; hargaGudang: number; stok: number; deskripsi: string }[] = [
  { nama: 'Wortel', varian: 'Frozen', hargaGudang: 13000, stok: 10000, deskripsi: 'Wortel beku siap olah' },
  { nama: 'Buncis', varian: 'Frozen', hargaGudang: 11000, stok: 10000, deskripsi: 'Buncis beku siap olah' },
  { nama: 'Jagung', varian: 'Frozen', hargaGudang: 10000, stok: 10000, deskripsi: 'Jagung manis beku siap olah' },
];
  ...
  for (const prod of PRODUK_BANDUNG) {
    ...
    await prisma.produkGudang.create({
      data: {
        ...
        kemasan: {
          create: [
            { ukuranKg: 1, stokKemasan: 10000 },
            { ukuranKg: 2.5, stokKemasan: 4000 }
          ]
        }
      },
    });
